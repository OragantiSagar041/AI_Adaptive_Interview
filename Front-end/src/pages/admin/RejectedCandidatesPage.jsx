      ...
      <section className="bg-card rounded-2xl border border-border shadow-sm p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          <div className="lg:col-span-1">
            <label className="block text-[11px] font-bold text-muted-foreground uppercase tracking-wider mb-2">Search Name / Email</label>
          ...
          <div>
            <label className="block text-[11px] font-bold text-muted-foreground uppercase tracking-wider mb-2">Job Position</label>
            <select
              value={jobFilter}
          ...
          <div>
            <label className="block text-[11px] font-bold text-muted-foreground uppercase tracking-wider mb-2">Interview Pipeline</label>
            <select
          ...
          <div>
            <label className="block text-[11px] font-bold text-muted-foreground uppercase tracking-wider mb-2">Specific Date</label>
            <input
              type="date"
              value={dateFilter}
                ...
                return (
                  <tr key={c.id || c.link_id || c.email} onClick={() => setSelectedCandidate(c)} className="hover:bg-rose-50/30 transition-colors group whitespace-nowrap cursor-pointer">
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-3">
                        <div className="flex h-10 w-10 items-center justify-center rounded-[0.75rem] bg-slate-100 dark:bg-slate-800/50 text-slate-600 dark:text-slate-400 font-bold shrink-0 shadow-sm border border-slate-200 dark:border-slate-700/50">
                    ...
                    <td className="px-5 py-4 text-right">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 text-xs font-bold rounded-lg hover:bg-slate-50 dark:bg-slate-900/50 dark:hover:bg-slate-700 hover:border-slate-300 transition-colors shadow-sm"
                      >
                ...
                <tr>
                  <td colSpan="7" className="py-16 text-center">
                    <div className="flex flex-col items-center justify-center text-slate-400">
                      ...
                      <p className="text-sm font-medium text-slate-500 dark:text-slate-400">No rejected candidates found matching your criteria</p>
                    </div>
                  </td>
                </tr>
              )}
