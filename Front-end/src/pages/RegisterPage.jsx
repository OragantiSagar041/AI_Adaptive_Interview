            ...
            {loadingPlans ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6 rounded-2xl border border-slate-700/60 bg-[#1e293b]/70 p-7 md:p-8 shadow-xl backdrop-blur-xl">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="mt-4 w-full cursor-pointer py-4 px-6 text-xs md:text-sm font-bold uppercase tracking-wider text-white rounded-xl transition-all duration-300 bg-gradient-to-r from-indigo-600 via-indigo-500 to-purple-600 shadow-lg hover:shadow-indigo-500/25 hover:opacity-95 disabled:opacity-50 disabled:cursor-not-allowed"
                >
