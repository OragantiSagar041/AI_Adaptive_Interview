    ...
    tasks_pool = [
        ...
        },
        {
            ...
            "test_cases": [
                ...
                {"id": 4, "input": [[1, 5, 3, 7], 8], "expected": [0, 3], "visible": False},
                {"id": 5, "input": [[-1, -2, -3, -4, -5], -8], "expected": [2, 4], "visible": False},
                {"id": 6, "input": [[10, 20, 30, 40], 50], "expected": [1, 2], "visible": False},
                ...
                {"id": 11, "input": [[1, 9, 3, 7], 10], "expected": [0, 1], "visible": False},
                {"id": 12, "input": [[2, 4, 6, 8], 10], "expected": [0, 3], "visible": False},
