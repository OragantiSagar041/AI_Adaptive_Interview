...
import { ArrowLeft, Save, User, Shield, CreditCard, Clock, Palette, Image as ImageIcon } from "lucide-react";
  ...
  if (!admin) {
    return (
      <div className="p-8 text-center">
        <p className="text-slate-500 mb-4">No admin details provided.</p>
        <button 
          onClick={() => navigate(-1)}
