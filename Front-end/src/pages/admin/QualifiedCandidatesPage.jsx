      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 py-8 space-y-8">
        ...
        <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {STATS.map((s) => (
            ...
            >
              <div className={cn("inline-flex h-10 w-10 items-center justify-center rounded-xl mb-3 shrink-0 border-2 border-slate-200/80 dark:border-slate-700/80 shadow-xs", s.colorClass)}>
