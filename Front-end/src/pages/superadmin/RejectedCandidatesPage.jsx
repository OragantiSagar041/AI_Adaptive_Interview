...
function StatCard({ icon: Icon, label, value, accent }) {
  return (
    <div className="bg-card rounded-xl border border-border/60 shadow-sm p-5 hover:shadow-md transition-shadow">
...
export default function RejectedCandidatesPage() {
  ...
  return (
    <div className="flex flex-col gap-6 min-h-screen bg-background text-foreground pb-12">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-card p-6 rounded-2xl border border-border/60 shadow-sm">
        ...
        <div className="flex items-center gap-3">
          <button onClick={() => alert("Talent pool synced")} className="flex items-center gap-2 px-4 py-2 bg-indigo-500/10 text-indigo-200 font-bold text-sm rounded-xl hover:bg-indigo-500/20 transition-colors">
      ...
      {/* Search & Filters */}
      <section className="bg-card rounded-2xl border border-border/60 shadow-sm p-5">
        <div className="flex items-center justify-between mb-5">
          ...
          <button 
            ...
            className="text-xs font-bold text-muted-foreground hover:text-foreground flex items-center gap-1 bg-muted/20 px-3 py-1.5 rounded-lg transition-colors"
          >
          ...
          <table className="w-full text-left border-collapse min-w-[900px]">
            <thead>
              <tr className="border-b border-border/70 bg-muted/10 whitespace-nowrap">
                ...
                <th className="py-4 px-5 text-xs font-bold text-muted-foreground uppercase tracking-wider">AI Recommendation</th>
                <th className="py-4 px-5 text-xs font-bold text-muted-foreground uppercase tracking-wider">Rejection Reason</th>
                <th className="py-4 px-5 text-xs font-bold text-muted-foreground uppercase tracking-wider">Rejected By</th>
                <th className="py-4 px-5 text-xs font-bold text-muted-foreground uppercase tracking-wider">Date & Time</th>
