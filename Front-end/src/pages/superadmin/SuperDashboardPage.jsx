      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card className="bg-card border border-border/80 shadow-sm rounded-2xl relative overflow-hidden flex flex-col justify-between hover:shadow-md transition-all">
          <CardContent className="p-4 flex flex-col h-full">
            ...
            <div className="mt-4 flex items-end justify-between">
              <div className="text-3xl font-bold text-foreground tracking-tight">{formatNum(dbStats?.total ?? dbStats?.today) || "0"}</div>
        ...
        <Card className="bg-card border border-border/80 shadow-sm rounded-2xl relative overflow-hidden flex flex-col justify-between hover:shadow-md transition-all">
          <CardContent className="p-4 flex flex-col h-full">
            ...
            <div className="mt-3 flex items-center justify-end text-[11px]">
              <span className="text-emerald-400 font-medium cursor-pointer flex items-center hover:underline" onClick={() => {
        ...
        <Card className="bg-card border border-border/80 shadow-sm rounded-2xl relative overflow-hidden flex flex-col justify-between hover:shadow-md transition-all">
          <CardContent className="p-4 flex flex-col h-full">
            ...
            <div className="mt-4 flex items-end justify-between">
              <div className="text-3xl font-bold text-foreground tracking-tight">{avgScore > 0 ? starRating.toFixed(1) : (formatNum(dbStats?.selected) || "0")}</div>
              <div className="text-right">
