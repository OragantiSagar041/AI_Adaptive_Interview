...
export default function RejectedCandidatesPage() {
  ...
  useEffect(() => {
    dispatch(loadSuperAdminRejectedCandidates(selectedAdminFilter))
  ...
  const handleExportAction = () => {
    ...
    dispatch(handleSuperAdminExportExcel(rejectedCandidates.map(c => ({
      ...c,
    ...
    <div className="flex flex-col gap-6">
      <div className="flex justify-between items-center flex-wrap gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500">Unsuccessful applicant records across admins</p>
        </div>
        <Button
