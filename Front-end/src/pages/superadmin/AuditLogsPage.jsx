    ...
    >
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500 mt-1">Immutable record of system events and admin actions.</p>
        </div>
          ...
          <div className="flex gap-4">
            <div className="relative">
              ...
              <input 
                ...
                className="pl-9 pr-4 py-2 text-sm bg-white border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 w-72 transition-all"
              />
            </div>
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-100 text-sm">
              {filteredLogs.map((log, idx) => (
                ...
                >
                  <td className="px-6 py-4 whitespace-nowrap text-slate-500 font-mono text-xs flex items-center gap-2">
