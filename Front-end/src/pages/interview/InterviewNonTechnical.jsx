          ...
          {!showAllSet ? (
            ...
            <div style={{ background: '#f0fdf4', padding: '3rem 2rem', borderRadius: '16px', border: '1px dashed #bbf7d0', maxWidth: '500px', margin: '0 auto' }}>
              ...
              <button onClick={() => {
                ...
                window.close(); setTimeout(() => { window.location.href = 'https://www.google.com'; }, 300);
                      ...
                      <div className="flex-1 flex flex-col gap-4">
                        ...
                        <div className="bg-indigo-50/80 p-5 rounded-[16px] border border-indigo-100 shadow-sm">
                          <h4 className="font-bold text-indigo-800 mb-2 text-[13px] uppercase tracking-wider flex items-center gap-2">
                            <Cpu size={16} className="text-indigo-600" /> Your Task
                          </h4>
                          <p className="text-indigo-900 text-[15px] leading-relaxed font-semibold m-0">
                            {currentQuestion.rawQuestion || currentQuestionText}
                          </p>
                        </div>
                      </div>
                    ) : (
